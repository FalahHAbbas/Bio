...
public class AnsiSDKLib {
  ...
  public native boolean CreateTemplate(int finger, byte[] pImage, byte[] pTemplate,
      int[] pTemplateSize);

  public native boolean VerifyTemplate(int finger, byte[] pImage, byte[] pTemplate,
      float[] pVerifyResult);

  public native boolean MatchTemplates(byte[] pProbeTemplate, byte[] pGaleryTemplate,
      float[] pMatchResult);

  public native boolean ConvertAnsiTemplateToIso(byte[] pAnsiTemplate, byte[] pIsoTemplate,
      int[] pIsoTemplateSize);
